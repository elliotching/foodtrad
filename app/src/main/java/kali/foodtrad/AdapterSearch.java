...
class AdapterSearch extends BaseAdapter {
    ...
    private static final String url_read_image = ResFR.URL_READING + "?small_img             =" ;//provide
...
//        if(data.get(position).distanceString.equals(locationunknown)){
//            holder.textDistance.setTextColor(R.color.c_);
//        }
